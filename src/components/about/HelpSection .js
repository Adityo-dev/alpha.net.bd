...
const HelpSection = () => {
    return (
      <div className={`bg-[url('/background.jpg')] bg-cover bg-center text-white rounded-lg p-10 relative overflow-hidden`}>
        ...
        <div className="flex flex-wrap justify-center gap-4">
          <a href="tel:+88 01823 662233" className="flex items-center gap-2 bg-blue-800 px-6 py-3 rounded-lg hover:bg-blue-700 transition">
