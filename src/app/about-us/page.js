      ...
      <div className="bg-[#F4F4F7] py-10 my-10">
        <div className="container mx-auto max-w-[1140px] px-2 flex flex-col md:flex-row items-center justify-between">
          ...
          <p className="text-[#444444] text-sm">
            Do you want to take advantage of our <br /> special offers? Please
            call us today.
          </p>
          <a
            href="tel:+88 01823 662233"
            className="py-2 px-3 bg-[#8BC34A] rounded-lg text-white font-medium flex gap-2 items-center justify-center"
          >
